...
const PrivacyandPolicy = () => {
  return (
    <div>
        ...
        <div className="text-white text-end font-semibold text-xl mr-10">
        Effective date: [July-13, 2023]
        </div>

      <div className="text-white text-center font-medium text-md m-6">
          Ferhana Charitable Organization
        ("us", "we", or "our") operates the Ferhana Charitable Organization
        ...
        pages, unique device identifiers, and other diagnostic data. Tracking &
        Cookies Data We use cookies and similar tracking technologies to track
        the activity on our Service and hold certain information. Cookies are
        ...
        use Security Cookies for security purposes. Use of Data Ferhana
        Charitable Organization uses the collected data for various purposes: -
        ...
        Service - To monitor the usage of the Service - To detect, prevent, and
        address technical issues Transfer of Data Your information, including
        ...
        your jurisdiction. If you are located outside [Country Name] and choose
        to provide information to us, please note that we transfer the data,
        including Personal Data, to [Country Name] and process it there. Your
        consent to this Privacy Policy followed by your submission of such
        information represents your agreement to that transfer. Ferhana
        Charitable Organization will take all the steps reasonably necessary to
        ...
        information. Disclosure of Data Legal Requirements Ferhana Charitable
        Organization may disclose your Personal Data in the good faith belief
        that such action is necessary to: - Comply with a legal obligation -
        Protect and defend the rights or property of Ferhana Charitable
        Organization - Prevent or investigate possible wrongdoing in connection
        with the Service - Protect the personal safety of users of the Service
        or the public - Protect against legal liability Security of Data The
        ...
        your Personal Data, we cannot guarantee its absolute security. Service
        Providers We may employ third-party companies and individuals to
        facilitate our Service ("Service Providers"), provide the Service on our
        ...
        disclose or use it for any other purpose. Links to Other Sites Our
        ...
        third-party sites or services. Children's Privacy Our Service does not
        address anyone under the age of 18 ("Children"). We do not knowingly
        collect personally identifiable information from anyone under the age of
        18. If you are a parent or guardian and you are aware that your Children
        have provided us with Personal Data, please contact us. If we become
        aware that we have collected Personal Data from children without
        verification of parental consent, we take steps to remove that
        information from our servers. Changes to This Privacy Policy We may
